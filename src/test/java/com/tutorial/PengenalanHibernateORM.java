...
public class PengenalanHibernateORM {
     ...
     * ● Artinya, kita tidak bisa menggunakan JPA secara langsung, harus menggunakan implementasinya atau JPA Provider, mirip seperti JDBC yang
     *   harus ada JDBC Driver nya sebagai implementasinya
