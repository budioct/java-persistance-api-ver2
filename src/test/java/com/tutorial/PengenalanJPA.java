...
public class PengenalanJPA {
     ...
     * ● ORM framework akan bertanggung jawab dalam melakukan sinkronisasi data yang kita ubah pada object dengan data di database,
     * yaitu dengan melakukan proses CRUD (Create, Read, Update dan Delete)
     ...
     * ● JPA sangat banyak digunakan oleh programmer Java, karena dengan menggunakan JPA, kita tidak perlu lagi melakukan hal manual seperti Query SQL,
     * manual transform ke Java Bean Class atau melakukan manual JOIN ke banyak Table
